...
CREATE TABLE "public"."health_facility" ("ID" INTEGER NOT NULL DEFAULT NEXTVAL('health_facility_id_seq'), "OSM_ID" DOUBLE PRECISION, "NAME" VARCHAR(200)  DEFAULT '' NOT NULL, "ADDRFULL" VARCHAR(250)  DEFAULT '' NOT NULL, "AMENITY" VARCHAR(50) , "X_CORD" DOUBLE PRECISION NOT NULL, "Y_CORD" DOUBLE PRECISION NOT NULL, "MODIFIED_BY" VARCHAR(250)  DEFAULT '' NOT NULL, "MODIFIED_DATE" TIMESTAMP NOT NULL);
...
CREATE TABLE "public"."health_official" ("id" INTEGER NOT NULL DEFAULT NEXTVAL('health_official_id_seq'), "first_name" VARCHAR(50)  DEFAULT '' NOT NULL, "last_name" VARCHAR(50)  DEFAULT '' NOT NULL, "email" VARCHAR(50)  DEFAULT '' NOT NULL, "dob" DATE, "gender" VARCHAR(3) , "phone" VARCHAR(45) , "occupation" VARCHAR(50)  DEFAULT '' NOT NULL, "organization" VARCHAR(50)  DEFAULT '' NOT NULL, "created_date" TIMESTAMP NOT NULL, "modified_date" TIMESTAMP NOT NULL);
...
CREATE TABLE "public"."pui_follow_up" ("id" INTEGER NOT NULL DEFAULT NEXTVAL('pui_follow_up_id_seq'), "created_date" TIMESTAMP, "description" VARCHAR(255) , "modified_by" VARCHAR(250) , "modified_date" TIMESTAMP, "option_selected" VARCHAR(255) , "pui_case_code" VARCHAR(255) , "questionier_id" INTEGER);
...
CREATE TABLE "public"."questionier" ("id" INTEGER NOT NULL DEFAULT NEXTVAL('questionier_id_seq'), "category" INTEGER, "created_date" TIMESTAMP, "description" VARCHAR(255) , "modified_by" VARCHAR(250) , "modified_date" TIMESTAMP, "options" VARCHAR(255) , "parent_id" INTEGER, "question" VARCHAR(255) );
...
CREATE TABLE "public"."role" ("id" INTEGER NOT NULL DEFAULT NEXTVAL('role_id_seq'), "name" VARCHAR(255)  DEFAULT '' NOT NULL, "enabled" INTEGER DEFAULT 1 NOT NULL);
...
CREATE TABLE "public"."eth_user" ("id" INTEGER NOT NULL DEFAULT NEXTVAL('eth_user_id_seq'), "username" VARCHAR(255)  DEFAULT '' NOT NULL, "password" VARCHAR(255)  DEFAULT '' NOT NULL, "first_name" VARCHAR(255)  DEFAULT '' NOT NULL, "last_name" VARCHAR(255) , "account_non_expired" INTEGER NOT NULL, "account_non_locked" INTEGER NOT NULL, "enabled" INTEGER NOT NULL, "last_access" TIMESTAMP NOT NULL);
