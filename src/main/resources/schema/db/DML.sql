...
INSERT INTO CONSTANT_ENUM(ENUM_NAME, ENUM_CODE, ENUM_TYPE, ENUM_LABEL, ENUM_DESC, DISABLED) VALUE("PUI_INFO","040","QUESTIONNIER_CATEGORY", "PUI Information", "Information about Person under investigation", 0);
INSERT INTO CONSTANT_ENUM(ENUM_NAME, ENUM_CODE, ENUM_TYPE, ENUM_LABEL, ENUM_DESC, DISABLED) VALUE("SYMPTOMS","041","QUESTIONNIER_CATEGORY", "Symptoms", "Symptoms", 0);
INSERT INTO CONSTANT_ENUM(ENUM_NAME, ENUM_CODE, ENUM_TYPE, ENUM_LABEL, ENUM_DESC, DISABLED) VALUE("EXISTING_CONDITION","042","QUESTIONNIER_CATEGORY", "Existing condition", "Existing condition", 0);